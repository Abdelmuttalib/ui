...
export type ThemePalette = Record<ThemePaletteName, Record<ThemePaletteVariableKey, string>>
...
export const themePalettes: ThemePalette = {
  'palette-1': {
    background: '0.9724 0.0096 72.66',
    foreground: '0.1875 0.0026 67.67',

    card: '1 0 0',
    'card-foreground': '0.1875 0.0026 67.67',

    popover: '1 0 0',
    'popover-foreground': '0.1875 0.0026 67.67',

    primary: '0.3502 0.0858 268.64' /* deep navy */,
    'primary-foreground': '1 0 0',

    secondary: '1 0 0',
    'secondary-foreground': '0.4621 0.0209 72.81',

    muted: '0.9611 0.0103 67.7',
    'muted-foreground': '0.4621 0.0209 72.81',

    accent: '0.831 0.0211 62.81' /* soft beige hover */,
    'accent-foreground': '0.1875 0.0026 67.67',

    destructive: '0.9611 0.0103 67.7',
    'destructive-foreground': '0.1875 0.0026 67.67',

    border: '0.9611 0.0103 67.7',
    input: '0.9611 0.0103 67.7',
    ring: '0.3502 0.0858 268.64',

    'sidebar-background': '0.9611 0.0103 67.7',
    'sidebar-foreground': '0.1875 0.0026 67.67',
    'sidebar-primary': '0.32 0.07 265',
    'sidebar-primary-foreground': '0.9611 0.0103 67.7',
    'sidebar-accent': '0.831 0.0211 62.81',
    'sidebar-accent-foreground': '0.1875 0.0026 67.67',
    'sidebar-border': '0.9611 0.0103 67.7',
    'sidebar-ring': '0.3502 0.0858 268.64',
    'chart-1': '0.9611 0.0103 67.7',
    'chart-2': '0.9611 0.0103 67.7',
    'chart-3': '0.9611 0.0103 67.7',
    'chart-4': '0.9611 0.0103 67.7',
    'chart-5': '0.9611 0.0103 67.7',
  },
  'palette-2': {
    background: '0.975 0.01 75',
    foreground: '0.19 0.01 70',

    card: '1 0 0',
    'card-foreground': '0.19 0.01 70',

    popover: '1 0 0',
    'popover-foreground': '0.19 0.01 70',

    primary: '0.32 0.07 265' /* softer navy */,
    'primary-foreground': '0.98 0 0',

    secondary: '1 0 0',
    'secondary-foreground': '0.45 0.02 75',

    muted: '0.94 0.02 80',
    'muted-foreground': '0.5 0.02 75',

    accent: '0.88 0.03 85' /* warm beige glow */,
    'accent-foreground': '0.19 0.01 70',
    ...
    'sidebar-primary': '0.25 0.02 255' /* cool navy */,
    'sidebar-primary-foreground': '0.98 0 0',
    'sidebar-accent': '0.88 0.03 85' /* warm beige glow */,
    'sidebar-accent-foreground': '0.19 0.01 70',
    'sidebar-ring': '0.32 0.07 265',
    'sidebar-border': '0.94 0.02 80',
    'chart-1': '0.98 0 0',
    'chart-2': '0.98 0 0',
    'chart-3': '0.98 0 0',
    'chart-4': '0.98 0 0',
  ...
  'palette-3': {
    ...
    primary: '0.25 0.02 255' /* cool navy */,
    'primary-foreground': '0.98 0 0',

    secondary: '1 0 0',
    'secondary-foreground': '0.45 0 0',
    ...
    accent: '0.95 0 0' /* barely visible hover */,
    ...
    'sidebar-accent': '0.88 0.03 85' /* warm beige glow */,
    'sidebar-accent-foreground': '0.19 0.01 70',
    'sidebar-ring': '0.25 0.02 255',
    'sidebar-border': '0.95 0 0',
    'chart-1': '0.98 0 0',
    'chart-2': '0.98 0 0',
    'chart-3': '0.98 0 0',
    'chart-4': '0.98 0 0',
  ...
  'palette-4': {
    background: '0.97 0.01 78',
    foreground: '0.18 0.01 65',

    card: '1 0 0',
    'card-foreground': '0.18 0.01 65',

    popover: '1 0 0',
    'popover-foreground': '0.18 0.01 65',

    primary: '0.33 0.06 270' /* elegant violet-navy */,
    'primary-foreground': '0.98 0 0',

    secondary: '1 0 0',
    'secondary-foreground': '0.48 0.02 70',

    muted: '0.96 0.01 75',
    'muted-foreground': '0.52 0.02 70',

    accent: '0.90 0.03 300' /* soft rose-beige hint */,
    'accent-foreground': '0.15 0 0',
    ...
    'sidebar-accent': '0.88 0.03 85' /* warm beige glow */,
    'sidebar-accent-foreground': '0.19 0.01 70',
    'sidebar-ring': '0.33 0.06 270',
    'sidebar-border': '0.96 0.01 75',
    'chart-1': '0.98 0 0',
    'chart-2': '0.98 0 0',
    'chart-3': '0.98 0 0',
    'chart-4': '0.98 0 0',
  ...
  'palette-5': {
    ...
    'muted-foreground': '0.542 0.017 285.786' /* oklch(0.542 0.017 285.786) */,
    ...
    'chart-4': '79.68% 0.103455 257.2023' /* oklch(79.68% 0.103455 257.2023) */,
    ...
    'sidebar-accent-foreground': '0.141 0.005 285.823' /* oklch(0.141 0.005 285.823) */,
  ...
  'palette-7': {
    background: '0.965 0.005 70',
    foreground: '0.17 0.005 60',

    card: '1 0 0',
    'card-foreground': '0.17 0.005 60',

    popover: '1 0 0',
    'popover-foreground': '0.17 0.005 60',

    primary: '0.30 0.08 260' /* strong medical navy */,
    'primary-foreground': '0.98 0 0',

    secondary: '1 0 0',
    'secondary-foreground': '0.45 0.01 65',

    muted: '0.95 0.01 70',
    'muted-foreground': '0.50 0.01 65',

    accent: '0.85 0.02 60' /* muted gold-beige */,
    'accent-foreground': '0.15 0 0',
    ...
    'sidebar-accent': '0.88 0.03 85' /* warm beige glow */,
    'sidebar-accent-foreground': '0.19 0.01 70',
    'sidebar-ring': '0.20 0 0',
    'sidebar-border': '0.90 0.01 85',
    'chart-1': '0.98 0 0',
    'chart-2': '0.98 0 0',
    'chart-3': '0.98 0 0',
    'chart-4': '0.98 0 0',
  ...
  'palette-8': {
    ...
    */
    ...
    popover: '1 0 0' /* oklch(1 0 0) */,
    'popover-foreground': '0.18 0.0581 267.75' /* oklch(0.18 0.0581 267.75) */,
    ...
    'sidebar-background': '1 0 0' /* oklch(1 0 0) */,
    'sidebar-foreground': '0.18 0.0581 267.75' /* oklch(0.18 0.0581 267.75) */,
    'sidebar-primary': '0.30 0.1037 277.24' /* oklch(0.30 0.1037 277.24) */,
    'sidebar-primary-foreground': '1 0 0' /* oklch(1 0 0) */,
    'sidebar-accent': '0.95 0.0749 286' /* oklch(0.95 0.0749 286) */,
    'sidebar-accent-foreground': '0.18 0.0581 267.75' /* oklch(0.18 0.0581 267.75) */,
    'sidebar-border': '0.93 0.0749 286' /* oklch(0.93 0.0749 286) */,
    'sidebar-ring': '0.38 0.1037 277.24' /* oklch(0.38 0.1037 277.24) */,
  },

  'palette-9': {
    // 🌿 BASE (warm ivory background)
    background: '0.97 0.01 85',
    foreground: '0.18 0.01 70', // soft charcoal, not pure black

    // 🧴 SURFACES (clean medical white)
    card: '0.99 0.005 85',
    'card-foreground': '0.18 0.01 70',

    popover: '0.99 0.005 85',
    'popover-foreground': '0.18 0.01 70',

    // 🖤 PRIMARY (CTA = soft black, not harsh)
    primary: '0.20 0 0',
    'primary-foreground': '0.99 0 0',

    // 🤍 SECONDARY (neutral ivory surface variation)
    secondary: '0.95 0.01 85',
    'secondary-foreground': '0.25 0.01 70',

    // 🌫 MUTED (UI separation, backgrounds, sections)
    muted: '0.93 0.01 85',
    'muted-foreground': '0.50 0.01 70',

    // ✨ ACCENT (extremely subtle hover layer)
    accent: '0.94 0.01 85',
    'accent-foreground': '0.18 0.01 70',
  ...
  'palette-13': {
    ...
    */
    ...
    'sidebar-accent-foreground': '0.18 0.019 230.11' /* oklch(0.18 0.019 230.11) */,
    'sidebar-border': '0.92 0 0' /* oklch(0.92 0 0) */,
  ...
  'palette-14': {
    ...
    */
    ...
    popover: '1 0 0' /* oklch(1 0 0) */,
    'popover-foreground': '0.18 0.0089 303.99' /* oklch(0.18 0.0089 303.99) */,
    ...
    'sidebar-background': '0.98 0 0' /* oklch(0.98 0 0) */,
    'sidebar-foreground': '0.18 0.0089 303.99' /* oklch(0.18 0.0089 303.99) */,
    'sidebar-primary': '0.55 0.2123 274.05' /* oklch(0.55 0.2123 274.05) */,
    'sidebar-primary-foreground': '1 0 0' /* oklch(1 0 0) */,
    'sidebar-accent': '0.95 0.0265 312.58' /* oklch(0.95 0.0265 312.58) */,
    'sidebar-accent-foreground': '0.18 0.0089 303.99' /* oklch(0.18 0.0089 303.99) */,
    'sidebar-border': '0.92 0 0' /* oklch(0.92 0 0) */,
  ...
  'palette-17': {
    ...
    */
    ...
    popover: '1 0 0' /* oklch(1 0 0) */,
    'popover-foreground': '0.18 0.0232 250.35' /* oklch(0.18 0.0232 250.35) */,
    ...
    'sidebar-background': '0.98 0.0232 250.35' /* oklch(0.98 0.0232 250.35) */,
    'sidebar-foreground': '0.18 0.0232 250.35' /* oklch(0.18 0.0232 250.35) */,
    'sidebar-primary': '0.68 0.127 166.4' /* oklch(0.68 0.127 166.4) */,
    'sidebar-primary-foreground': '1 0 0' /* oklch(1 0 0) */,
    'sidebar-accent': '0.94 0.0512 277.28' /* oklch(0.94 0.0512 277.28) */,
    'sidebar-accent-foreground': '0.18 0.0232 250.35' /* oklch(0.18 0.0232 250.35) */,
  ...
  'palette-18': {
    ...
    */
    ...
    'sidebar-accent-foreground': '0.18 0.0283 137.86' /* oklch(0.18 0.0283 137.86) */,
    'sidebar-border': '0.92 0.0132 250.35' /* oklch(0.92 0.0132 250.35) */,
  ...
  'palette-19': {
    ...
    // background
    oklch(0.9786 0.0124 75.37)

    // layer
    oklch(0.9482 0.021 72.15)

    oklch(0.9945 0.0057 84.57)

    oklch(0.3966 0.062 41.23)

    //
    oklch(0.5625 0.084 63.43)

    */

    background: '0.9786 0.0124 75.37' /* oklch(0.9786 0.0124 75.37) */,
    foreground: '0.3966 0.062 41.23' /* oklch(0.3966 0.062 41.23) */,
    card: '0.9945 0.0057 84.57' /* oklch(0.9945 0.0057 84.57) */,
    'card-foreground': '0.18 0 0' /* oklch(0.18 0 0) */,
    popover: '1 0 0' /* oklch(1 0 0) */,
    'popover-foreground': '0.18 0 0' /* oklch(0.18 0 0) */,
    primary: '0.5625 0.084 63.43' /* oklch(0.5625 0.084 63.43) */,
    'primary-foreground': '1 0 0' /* oklch(1 0 0) */,
    secondary: '0.9082 0.021 72.15' /* oklch(0.9082 0.021 72.15) */,
    'secondary-foreground': '0.2482 0.021 72.15' /* oklch(0.2482 0.021 72.15) */,
    muted: '0.9482 0.021 72.15' /* oklch(0.9482 0.021 72.15) */,
    'muted-foreground': '0.61 0.021 72.15' /* oklch(0.61 0.021 72.15) */,
    accent: '0.9682 0.021 72.15' /* oklch(0.9682 0.021 72.15) */,
    'accent-foreground': '0.18 0.021 72.15' /* oklch(0.18 0.021 72.15) */,
    destructive: '0.59 0.1488 8.72' /* oklch(0.59 0.1488 8.72) */,
    'destructive-foreground': '1 0 0' /* oklch(1 0 0) */,
    border: '0.92 0.021 72.15' /* oklch(0.92 0.021 72.15) */,
    input: '0.90 0.021 72.15' /* oklch(0.90 0.021 72.15) */,
    ring: '0.36 0.021 72.15' /* oklch(0.36 0.021 72.15) */,
  ...
  'palette-20': {
    /* Base */
    background: '0.9724 0.0096 72.66' /* warm ivory */,
    foreground: '0.1875 0.0026 67.67' /* deep charcoal */,
    ...
    /* Primary (still navy = authority) */
    primary: '0.3502 0.0858 268.64' /* deep navy */,
    'primary-foreground': '1 0 0',

    /* Secondary → FIXED (no more “disabled look”) */
    secondary: '1 0 0' /* white */,
    'secondary-foreground': '0.4621 0.0209 72.81' /* soft gray text */,

    /* Muted surfaces (very subtle separation) */
    muted: '0.9611 0.0103 67.7' /* warm off-white */,
    'muted-foreground': '0.4621 0.0209 72.81',

    /* Accent → NOW VERY SUBTLE (hover only role) */
    accent: '0.831 0.0211 62.81' /* soft warm beige */,
    'accent-foreground': '0.1875 0.0026 67.67',

    /* Borders (barely visible luxury lines) */
    border: '0.9611 0.0103 67.7',
    input: '0.9611 0.0103 67.7',
    ring: '0.831 0.0211 62.81',

    /* Destructive (kept restrained) */
    destructive: '0.5589 0.0945 47.75',
    'destructive-foreground': '1 0 0',

    /* Charts (optional dashboard use) */
    'chart-1': '0.3502 0.0858 268.64',
    'chart-2': '0.831 0.0211 62.81',
    'chart-3': '0.6038 0.0484 272.23',
    'chart-4': '0.4621 0.0209 72.81',
    'chart-5': '0.7231 0.0742 56.55',

    /* Sidebar */
    'sidebar-background': '1 0 0',
    'sidebar-foreground': '0.1875 0.0026 67.67',
    'sidebar-primary': '0.3502 0.0858 268.64',
    'sidebar-primary-foreground': '1 0 0',
    'sidebar-accent': '0.9611 0.0103 67.7',
    'sidebar-accent-foreground': '0.1875 0.0026 67.67',
    'sidebar-border': '0.9611 0.0103 67.7',
    'sidebar-ring': '0.831 0.0211 62.81',
  },

  'palette-21': {
    background: '0.985 0.004 95' /* soft architectural white */,
    foreground: '0.28 0.03 260' /* elegant deep navy text */,

    card: '0.995 0.003 95' /* luxury white card */,
    'card-foreground': '0.24 0.03 260',

    popover: '1 0 0',
    'popover-foreground': '0.24 0.03 260',

    primary: '0.33 0.09 266' /* #22336A royal clinic navy */,
    'primary-foreground': '0.99 0.002 95',

    secondary: '0.94 0.01 85' /* warm luxury neutral */,
    'secondary-foreground': '0.28 0.03 260',

    muted: '0.965 0.006 85' /* soft warm gray */,
    'muted-foreground': '0.52 0.02 255',

    accent: '0.72 0.14 85' /* refined gold accent */,
    'accent-foreground': '0.18 0.01 85',

    destructive: '0.58 0.19 28',
    'destructive-foreground': '1 0 0',

    border: '0.92 0.008 85' /* elegant subtle border */,
    input: '0.94 0.006 85',
    ring: '0.42 0.09 266',
   ...
   * =========================================
   * ROYAL CLINICAL
   * Main recommended palette
   * =========================================
   */
  'palette-22': {
    background: '0.985 0.004 95',
    foreground: '0.28 0.03 260',
    ...
    primary: '0.33 0.09 266',
    'primary-foreground': '0.99 0.002 95',

    secondary: '0.94 0.01 85',
    'secondary-foreground': '0.28 0.03 260',

    muted: '0.965 0.006 85',
    'muted-foreground': '0.52 0.02 255',
   ...
   * =========================================
   * IMPERIAL GOLD
   * More luxury hospitality feeling
   * =========================================
   */
  'palette-23': {
    background: '0.982 0.006 85',
    foreground: '0.24 0.025 250',

    card: '0.995 0.002 90',
    'card-foreground': '0.24 0.025 250',

    popover: '1 0 0',
    'popover-foreground': '0.24 0.025 250',

    primary: '0.29 0.08 265',
    'primary-foreground': '1 0 0',

    secondary: '0.93 0.015 85',
    'secondary-foreground': '0.24 0.025 250',

    muted: '0.955 0.008 85',
    'muted-foreground': '0.52 0.015 250',

    accent: '0.78 0.12 82',
    'accent-foreground': '0.18 0.01 85',

    destructive: '0.59 0.18 28',
    'destructive-foreground': '1 0 0',

    border: '0.91 0.008 85',
    input: '0.93 0.008 85',
    ring: '0.38 0.08 265',
   ...
   * =========================================
   * MODERN EXECUTIVE
   * More minimal / Swiss / Apple-like
   * =========================================
   */
  'palette-24': {
    background: '0.988 0.002 250',
    foreground: '0.22 0.018 255',

    card: '1 0 0',
    'card-foreground': '0.22 0.018 255',

    popover: '1 0 0',
    'popover-foreground': '0.22 0.018 255',

    primary: '0.31 0.07 262',
    'primary-foreground': '1 0 0',

    secondary: '0.95 0.004 255',
    'secondary-foreground': '0.22 0.018 255',

    muted: '0.965 0.003 255',
    'muted-foreground': '0.55 0.01 255',

    accent: '0.68 0.08 80',
    'accent-foreground': '0.18 0.01 80',

    destructive: '0.58 0.18 28',
    'destructive-foreground': '1 0 0',

    border: '0.92 0.004 255',
    input: '0.94 0.004 255',
    ring: '0.38 0.07 262',
  ...
  'palette-25': {
    ...
    background: '0.985 0.004 95',
    /* warm clean white (clinic walls feel) */

    foreground: '0.22 0.01 255',
    /* soft navy-gray text (not pure black) */

    card: '0.97 0.005 95',
    /* slightly tinted white for depth */

    'card-foreground': '0.22 0.01 255',

    popover: '0.99 0.003 95',
    'popover-foreground': '0.22 0.01 255',

    /* ===== BRAND PRIMARY (NAVY - TRUST) ===== */

    primary: '0.32 0.06 260',
    /* deep clinic navy (logos, headings emphasis) */

    'primary-foreground': '0.985 0.004 95',

    /* ===== SECONDARY SURFACES ===== */

    secondary: '0.94 0.006 95',
    /* soft layered white */

    'secondary-foreground': '0.30 0.02 255',

    muted: '0.92 0.005 95',
    /* backgrounds for subtle sections */

    'muted-foreground': '0.45 0.01 255',

    /* ===== ACCENT (GOLD - PREMIUM SIGNAL) ===== */

    accent: '0.78 0.14 85',
    /* controlled gold (NOT yellow, not flashy) */

    'accent-foreground': '0.15 0.02 260',

    /* ===== SYSTEM UI ===== */

    border: '0.90 0.004 95',
    input: '0.90 0.004 95',
    ring: '0.78 0.14 85',
    ...
    destructive: '0.62 0.18 25',
    'destructive-foreground': '0.98 0.01 95',
...
export const DEFAULT_THEME_PALETTE = 'palette-1'
