...
type FontSize = 'xs' | 'sm' | 'base' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' | '4xl' | '5xl' | '6xl' | '7xl'
...
const typographyVariants = cva('font-normal text-foreground', {
  variants: {
    variant: {
      ...
      // base
      'base/normal': 'text-sm font-normal sm:text-base',
      'base/medium': 'text-sm font-medium sm:text-base',
      'base/semibold': 'text-sm font-semibold sm:text-base',
      'base/bold': 'text-sm font-bold sm:text-base',
      'base/extrabold': 'text-sm font-extrabold sm:text-base',
...
function Typography({ as = 'p', variant = 'base/normal', className, ...props }: TypographyProps) {
  const Comp = as
